...
All these chages to the network would require a new method for infering the weights of the adjancency matrix and this could prove to be challenging. For this reason, the feasibility of this option will only be considered when other, more important milestones, are completed.
...
\begin{table}
    ...
    \begin{tabular}{|c|c|}
		...
		\hline
		 ...
		 February & Create a function that relates the computation time of\\
		 & the algorithm to the number of nodes. \\
		\hline
